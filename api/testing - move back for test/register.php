	...
	<div class="container container-main">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<form style="width:40%;" action="index.php" method="post">
					  ...
					  <div class="checkbox">
					    <label>
					      <input type="checkbox" name="vphone"> Phone number visible to others
					    </label>
					  </div>
					  <div class="checkbox">
					    <label>
					  ...
					  <input type="hidden" value="register" name="tag">
