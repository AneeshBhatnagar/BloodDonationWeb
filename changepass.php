...
<html>
<head>
	<title>Change Password | Aneesh Bhatnagar</title>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<?php 
					...
					<button type="submit" class="btn btn-success">Update Password</button>
						...
						echo "Please check the link that you have clicked! It is invalid.";
					}
							...
							if($newpass2 != $newpass){
								...
								if($result){
									...
									if($num_rows > 0){
										...
										if($SQL){
											echo "Password Updated Successfully! <a href='login.php'>Click here</a> to go login!";
										}
										else{
